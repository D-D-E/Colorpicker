...
const char htmlpicker1[] = {"<html><head><title>ESP8266</title></head><body><script>let flag = true;function setFlag(){flag = false;};function reload(){if(flag){document.location.reload(true);}};setTimeout(reload, 5000);</script><p>Choose your color:</p><form method=\"post\"><input type=\"color\" value=\"#"};
const char htmlpicker2[] = {"\" id=\"cp\" onclick=\"setFlag()\" name=\"picker\" /><input type=\"submit\" value=\"SEND\" /></form></body></html>"};

const char htmlconfig[] = {"<html><head><title>ESP8266_config</title></head><body><script></script><p>Set params:</p><form method=\"post\"><table width=\"100%\" cellspacing=\"0\" cellpadding=\"4\"><tr><td align=\"right\" width=\"60\">SSID:</td><td><input type=\"text\" id=\"ssid\" name=\"ssid\"/></td></tr><tr><td align=\"right\" width=\"60\">Password:</td><td><input type=\"text\" id=\"paswd\" name=\"paswd\"/></td></tr><tr><td align=\"right\" width=\"60\">DNS:</td><td><input type=\"text\" id=\"dns\" name=\"dns\"/></td></tr></table><p><input type=\"submit\" id=\"sb\" value=\"SEND\"/></p></form></body></html>"};
